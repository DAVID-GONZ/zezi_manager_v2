        ...
        with self._get_conn() as conn:
            cursor = conn.execute(
                ...
                (
                    ...
                    cierre.asignacion_id,
                    cierre.anio_id,
                    float(cierre.nota_promedio_periodos),
                    float(cierre.nota_habilitacion) if cierre.nota_habilitacion is not None else None,
                    float(cierre.nota_definitiva_anual),
                    int(cierre.perdio),
                    cierre.desempeno_id,
                    cierre.fecha_cierre.isoformat(),
                    cierre.usuario_cierre_id,
