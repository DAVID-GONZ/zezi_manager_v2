        ...
        with _get_conn() as conn:
            cur = conn.execute(
                ...
                (
                    ...
                    float(corte.peso_registrado),
                    float(corte.nota_umbral),
                    float(corte.nota_minima_aprobacion),
                    corte.usuario_id,
                ),
            )
        ...
        with _get_conn() as conn:
            cur = conn.execute(
                ...
                (
                    ...
                    nota.asignacion_id,
                    nota.periodo_id,
                    float(nota.nota_al_corte),
                    float(nota.nota_definitiva_plan) if nota.nota_definitiva_plan is not None else None,
                    nota.estado.value,
