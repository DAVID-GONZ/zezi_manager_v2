"""
Catálogo DIVIPOLA — Departamentos y municipios de Colombia.
================================================================
...
DEPARTAMENTOS: list[str] = sorted(_DIVIPOLA.keys())


def municipios_de(departamento: str) -> list[str]:
    """Retorna los municipios de un departamento (lista vacía si no existe)."""
    return _DIVIPOLA.get(departamento, [])


__all__ = ["DEPARTAMENTOS", "municipios_de"]
